...
# Start Perfect AI (Player 3)
python3 ai_player_perfect.py > logs_perfect_ai.txt 2>&1 &
PID_PERFECT=$!
echo "✓ Perfect AI started (PID: $PID_PERFECT) on port 5003"
